...
class FrameWidget(MasterWidget):
    def __init__(self, master, width = None, height = None, relief = None, columnspan = None, **kwargs):
        ...
        self.frame = tk.Frame(master = self.master, width = self.width, height = self.height, bg = self.bg, fg = self.fg, relief = self.relief)
